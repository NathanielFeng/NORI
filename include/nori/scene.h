...
public:
    ...
    // If there are several light sources in the scene,
    // we should pick one uniformly at random
    Emitter *sampleEmitter(Sampler *sampler) const;

    float sampleEmitterPdf() const { return 1.0f / m_emitters.size(); }
